...
async function main() {
  ...
  //  const interest = "0xaF8749DA37232f2bbf3375642079841DCeEE0a4A"
   ...
   // const DepositVault = new hre.ethers.Contract(DV, depositABI.abi, deployer);
    ...
    const InitRatesREXE = await _Interest.initInterest(await REXE, 1, REXEinterestRateInfo, REXEInterestRate)
    const InitRatesUSDT = await _Interest.initInterest(await USDT, 1, USDT_interestRateInfo, USDTInterestRate)
